...
const faqItems = [
  {
    ...
    answer:
      "Le Hajj est le pèlerinage obligatoire que tout musulman doit accomplir une fois dans sa vie s'il en a les moyens, pendant une période précise du calendrier islamique. L'Omra est un pèlerinage mineur qui peut être accompli à tout moment de l'année.",
  },
  {
    question: "Quels documents sont nécessaires pour réserver un voyage ?",
    answer:
      "Pour réserver un voyage Hajj ou Omra, vous aurez généralement besoin d'un passeport valide au moins 6 mois après votre date de retour, un visa spécial pèlerinage, une preuve de vaccination selon les exigences sanitaires en vigueur, et parfois une attestation de mariage pour les femmes accompagnées de leur époux.",
  },
  {
    question: "Comment choisir la bonne agence de voyage ?",
    answer:
      "Pour choisir une bonne agence, vérifiez qu'elle possède une licence officielle, lisez les avis des clients précédents, comparez les offres et services inclus, assurez-vous qu'elle offre un accompagnement spirituel, et renseignez-vous sur l'hébergement et la proximité des lieux saints.",
  },
  {
    question: "Quelle est la meilleure période pour effectuer l'Omra ?",
    answer:
      "L'Omra peut être effectuée à tout moment de l'année. Cependant, les périodes les plus spirituelles sont le mois de Ramadan et les mois sacrés du calendrier islamique. Les périodes moins fréquentées peuvent offrir une expérience plus sereine et souvent des prix plus avantageux.",
  },
  {
    question: "Les prix affichés incluent-ils tous les frais ?",
    answer:
      "Les prix affichés comprennent généralement le vol, l'hébergement, les transferts et l'accompagnement. Cependant, certains frais peuvent être exclus comme les repas, les assurances, ou certaines taxes. Il est toujours recommandé de vérifier précisément ce qui est inclus dans chaque offre.",
  },
];
      ...
      <section className="container mx-auto px-4 py-12 md:px-6">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <div className="flex flex-col items-center rounded-lg border border-noor-dark-lighter bg-noor-dark-light p-6 text-center">
            ...
            <h3 className="mb-2 font-serif text-xl font-medium text-noor-gold">
              Qualité
            </h3>
            <p className="text-gray-300">
              Des agences rigoureusement sélectionnées pour garantir une
              expérience spirituelle de qualité.
            </p>
          </div>
          <div className="flex flex-col items-center rounded-lg border border-noor-dark-lighter bg-noor-dark-light p-6 text-center">
            <div className="mb-4 flex h-14 w-14 items-center justify-center rounded-full bg-noor-gold/20">
            ...
            <p className="text-gray-300">
              Trouvez facilement une agence proche de chez vous pour un
          ...
          <div className="flex flex-col items-center rounded-lg border border-noor-dark-lighter bg-noor-dark-light p-6 text-center">
            ...
            <p className="text-gray-300">
              Des offres variées pour tous les budgets et toutes les périodes de
              l'année.
            </p>
          </div>
        </div>
      ...
      <section className="container mx-auto px-4 py-12 md:px-6">
        <div className="mb-8 flex items-center justify-between">
          ...
          <Button
            asChild
            variant="ghost"
            className="text-noor-gold hover:text-noor-gold/90"
          >
          ...
          {products.slice(0, 4).map((product) => (
            ...
            >
              ...
              <div className="p-4">
                ...
                <p className="mb-3 text-sm text-gray-300">Par {product.name}</p>
                ...
                <div className="mt-4 flex items-center justify-between">
                  ...
                  <Button
                    variant="ghost"
                    size="sm"
                    className="text-xs text-noor-gold"
                  >
                    Détails
                  </Button>
                </div>
          ...
          {agencies.slice(0, 4).map((agency) => (
            ...
            >
              ...
              <Button
                variant="ghost"
                size="sm"
                className="mt-auto text-noor-gold"
              >
                Voir l'agence
              </Button>
            </Link>
          ...
          <Accordion type="single" collapsible className="w-full">
            {faqItems.map((faq, index) => (
              <AccordionItem
                key={index}
                value={`item-${index}`}
                className="border-noor-dark-lighter"
              >
